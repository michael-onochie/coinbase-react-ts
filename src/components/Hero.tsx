    ...
    <>
        ...
        <style jsx>
            ...
            <div className="flex flex-col-reverse h-[56rem] md:h-[35rem] bottom-[18rem] md:bottom-0 md:grid md:grid-cols-2 md:-space-x-10 relative ">
                {/* left */}
                <div className="flex flex-col items-center md:flex-col md:ps-20 md:items-start justify-center text-center md:text-start space-y-5 md:space-y-16 relative md:bottom-16">
                    <h1 className="text-2xl md:text-3xl md:tracking-wider" id="hero-h1">
                ...
                <div className="relative md:flex md:flex-col bottom-10 mx-auto animate__animated animate__bounce">
